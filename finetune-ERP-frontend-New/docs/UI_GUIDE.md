...
| `MultiSlideReel`                                | `src/components/layout`           | horizontally scrollable reel with session-aware swipe hints, CSS scroll snapping, ScrollModeContext integration, and RTL support                                                                                                                                                                                                                                                                                                                             |
|                                                 |
