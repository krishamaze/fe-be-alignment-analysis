  ...
  return (
    <>
      ...
      <div className="p-4 pt-24 max-w-3xl mx-auto space-y-4">
        ...
        <p>
          1.1 The terms set out in these Conditions of Repair (“Agreement”)
          shall apply to the service (“Service”) we provide to repair your
          smartphone, tablet, computer and/or any accessories (“Device”).
        </p>
        <p>
          1.2 References to “us”, “we” and “our” refer to Finetune and
          references to “you” and “your” are to you, the person addressed on
          this form.
        </p>
        ...
        <p>
          ...
          shall continue until we have repaired or otherwise returned your
          Device.
        </p>
        <p>
        ...
        <p>
          2.5 Any time estimate for completion of the service is an estimate
          only and does not form any obligation under this Agreement.
        </p>
        <p>
        ...
        <p>
          2.12 Our products and repairs are covered by the warranty terms
          outlined below.
        </p>
