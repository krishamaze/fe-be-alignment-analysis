      ...
      questions: [
        {
          ...
          answer: "Standard shipping takes 3-5 business days. Express shipping (1-2 days) is available for select locations. International shipping takes 7-14 business days."
        },
        {
      ...
      questions: [
        {
          ...
          answer: "We offer a 30-day return policy for most products. Items must be in original condition with all packaging. Some products have different return policies."
        },
        {
      ...
      questions: [
        {
          ...
          answer: "We accept all major credit/debit cards, UPI, net banking, digital wallets (Paytm, PhonePe, Google Pay), and EMI options."
        },
        {
          question: "Is my payment information secure?",
          answer: "Yes, we use industry-standard SSL encryption and PCI DSS compliance to protect your payment information. We never store your card details."
        },
        {
          question: "Do you offer EMI options?",
          answer: "Yes, we offer EMI options through various banks and financial institutions. You can select EMI during checkout for eligible products."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "Yes, all products come with manufacturer warranty. Warranty period varies by product and brand. Check product details for specific warranty information."
        },
        {
          question: "How do I claim warranty?",
          answer: "For warranty claims, contact our support team with your order details and issue description. We'll guide you through the warranty process."
        },
        {
          question: "Do you provide technical support?",
          answer: "Yes, our technical support team is available to help with product setup, troubleshooting, and general questions about your purchases."
        }
      ]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We're here to help! Find answers to common questions, get in touch with our support team, 
            or visit our store for personalized assistance.
          </p>
        </div>
            ...
            {activeTab === 'contact' && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Store Location</h3>
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        {/* <HiOutlineMapPin className="w-5 h-5 text-orange-600 mt-1" /> */}
                        <div className="text-gray-700 whitespace-pre-line">{contactInfo.address}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    For urgent technical issues or order problems, please call our emergency support line:
                  </p>
                  <div className="flex items-center gap-3">
                    <HiOutlinePhone className="w-5 h-5 text-red-600" />
                    <span className="font-semibold text-red-600">+91-1800-999-8888</span>
                    <span className="text-sm text-gray-500">(24/7 Emergency Support)</span>
                  </div>
                </div>
              </div>
            )}
