    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4 py-6">
      <div className="w-full max-w-sm space-y-4">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-gray-800" style= {{marginTop : '15%'}}>
            Sign Up</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex items-start gap-2 text-xs">
            ...
            <span className="text-gray-600">
              I agree to the{' '}
              <Link to="/legal" className="text-gray-700 hover:text-keyline hover:underline">
        ...
        <div className="text-center text-sm text-gray-600">
          ...
          <Link to="/login" className="text-gray-700 hover:text-keyline hover:underline font-medium">
            Sign in
          </Link>
        </div>
      </div>
