...
const BACKEND_URL = "https://script.google.com/macros/s/AKfycbxcANXk6gBddr0yIV_owEaxueJvxtvJX_Jkq8flGGVOL9hNCljPNyI-GdJ2A-jSZtcA/exec";
...
function GiveawayRedemption() {
  ...
  return (
    <div className="max-w-xl mx-auto mt-20 md:mt-8 bg-white p-6 rounded shadow">
      <h2 className="text-xl font-bold mb-4 text-center">🎁 Giveaway Redemption</h2>
      ...
      {refNo ? (
        ...
        <div className="bg-green-100 p-4 rounded text-center text-green-800 font-semibold space-y-2">
          ...
          <p>Ref No: <span className="font-mono">{refNo}</span></p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium mb-1">Instagram ID</label>
              <input 
          ...
          <div className="bg-gray-50 p-3 rounded text-sm">
            ₹100 discount auto-applied. Final Price: <b>₹{calculateFinalPrice()}</b>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <input 
              ...
              className="rounded"
            />
            <label htmlFor="received-checkbox" className="text-sm cursor-pointer">
