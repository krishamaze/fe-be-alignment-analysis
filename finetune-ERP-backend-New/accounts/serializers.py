...
class RegisterUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['id', 'first_name', 'last_name', 'username', 'email', 'password', 'role', 'phone', 'store']
        extra_kwargs = {
...
class CustomUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['id', 'first_name', 'last_name', 'username', 'email', 'role', 'phone', 'store', 'store_name', 'is_active', 'date_joined', 'last_login']
        extra_kwargs = {
